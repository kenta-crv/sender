...
post "/twilio/voice" do
  ...
  response = Twilio::TwiML::VoiceResponse.new do |r|
    if mode == "transfer_test"
      ...
      # 音声認識テストモード: 挨拶 → Gather
      twiml_say(r, "お電話ありがとうございます。株式会社テストでございます。ご担当者様はいらっしゃいますでしょうか。")
      r.gather(
        input: "speech",
        language: "ja-JP",
        hints: "不在にしております,いません,おりません,いないです,留守にしております,出かけております,席を外しております,ご用件は,結構です,必要ありません,間に合っております,いらないです,大丈夫です,お電話代わりました,お電話かわりました,電話代わりました,少々お待ちください,お待ちください",
